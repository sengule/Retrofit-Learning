package com.ertu_.retrofitjava.adapter;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.RowHolder> {
    ...
    public RecycleViewAdapter(ArrayList<Model> cryptoList) {
    ...
    public class RowHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Model cryptoModel,String[] colors, Integer position) {
